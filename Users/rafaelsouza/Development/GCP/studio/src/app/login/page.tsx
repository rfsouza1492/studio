...
const LoginPage: React.FC = () => {
  ...
  // O redirecionamento agora é tratado exclusivamente pelo PrivateRoute
  // useEffect(() => {
  //   if (!loading && user) {
  //     router.replace('/');
  //   }
  ...
  // O PrivateRoute já mostra uma tela de carregamento, 
  // mas manter uma aqui evita um flash de conteúdo se o roteamento demorar.
  if (loading || user) {
    return (
