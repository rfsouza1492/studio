...
2.  [Guia de Funcionalidades](#2-guia-de-funcionalidades)
    ...
    *   [Importação de Tarefas do HubSpot](#importação-de-tarefas-do-hubspot)
...
-   **Como usar:** Acesse a página para ver sua lista de prioridades do dia e marque as tarefas à medida que as conclui. O sistema também cria automaticamente tarefas diárias recorrentes nesta página.
...
### Importação de Tarefas do HubSpot

-   **O que é:** Uma ferramenta poderosa para popular rapidamente seu GoalFlow.
-   **Como usar:** Clique no botão **"Importar HubSpot"** no cabeçalho para abrir um diálogo onde você pode selecionar e importar 52 tarefas pré-definidas, organizadas em 6 projetos, diretamente para suas metas.
